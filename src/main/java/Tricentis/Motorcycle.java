...
public class Motorcycle {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id=\"nav_motorcycle\"]")).click();
		
		driver.findElement(By.xpath("//*[@id=\"make\"]/option[3]")).click();
		
		driver.findElement(By.xpath("//*[@id=\"model\"]/option[5]")).click();
		
		driver.findElement(By.xpath("//*[@id=\"cylindercapacity\"]")).sendKeys("600");

		driver.findElement(By.xpath("//*[@id=\"engineperformance\"]")).sendKeys("1000");

		driver.findElement(By.xpath("//*[@id=\"dateofmanufacture\"]")).sendKeys("07/18/2024");

		driver.findElement(By.xpath("//*[@id=\"numberofseatsmotorcycle\"]")).sendKeys("2");
		
		driver.findElement(By.xpath("//*[@id=\"listprice\"]")).sendKeys("9999");
		...
		FileUtils.copyFile(f1, new File("E:\\Seed Infotech\\SEED_SDET_COURSE_AUTOMATION_TESTING\\SEED_SDET_COURSE_AUTOMATION_TESTING\\src\\main\\java\\Tricentis\\insurancebike.png"));
