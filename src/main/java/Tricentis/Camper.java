...
public class Camper {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		FileUtils.copyFile(f1, new File("E:\\Seed Infotech\\SEED_SDET_COURSE_AUTOMATION_TESTING\\SEED_SDET_COURSE_AUTOMATION_TESTING\\src\\main\\java\\Tricentis\\insurancecamper.png"));
